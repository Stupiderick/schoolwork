...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
    ...
    color.red = (uint8_t)(color1.red - floor(d * color1.red / theRadius) + floor(d * color2.red / theRadius));
    color.green = (uint8_t)(color1.green - floor(d * color1.green / theRadius) + floor(d * color2.green / theRadius));
    color.blue = (uint8_t)(color1.blue - floor(d * color1.blue / theRadius) + floor(d * color2.blue / theRadius));
